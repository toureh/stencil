import type { CompilerSystem, CompilerSystemMakeDirectoryResults, CompilerSystemRealpathResults, CompilerSystemUnlinkResults, CompilerSystemWriteFileResults, Logger, SystemDetails } from '../../declarations';
